...
@interface SJBounceAnimation (Private)
...
- (NSArray *)createRectArrayFromXValues:(NSArray *)xValues yValues:(NSArray *)yValues
                                 widths:(NSArray *)widths heights:(NSArray *)heights;

- (NSArray *)createColorArrayFromRed:(NSArray *)redValues green:(NSArray *)greenValues
                                blue:(NSArray *)blueValues alpha:(NSArray *)alphaValues;

- (NSArray *)createTransformArrayFromM11:(NSArray *)m11 M12:(NSArray *)m12
                                     M13:(NSArray *)m13 M14:(NSArray *)m14
                                     M21:(NSArray *)m21 M22:(NSArray *)m22
                                     M23:(NSArray *)m23 M14:(NSArray *)m24
                                     M31:(NSArray *)m31 M32:(NSArray *)m32
                                     M33:(NSArray *)m33 M14:(NSArray *)m34
                                     M41:(NSArray *)m41 M42:(NSArray *)m42
                                     M43:(NSArray *)m43 M14:(NSArray *)m44;

@end


@implementation SJBounceAnimation
...
- (id)initWithKeyPath:(NSString *)keyPath {
    ...
    if (self) {
        ...
        self.stiffness = SJBounceAnimationStiffnessMedium;
    }
    return self;
}
...
- (void)setStiffness:(SJBounceAnimationStiffness)stiffness {
    [super setValue:@(stiffness) forKey:@"stifnessKey"];
    [self createValueArray];
}

- (SJBounceAnimationStiffness)stiffness {
    return [[super valueForKey:@"stifnessKey"] intValue];
}
...
//            TTDWARNING(@"from %0.2f %0.2f %0.2f %0.2f", fromComponents[0], fromComponents[1], fromComponents[2], fromComponents[3]);
//            TTDWARNING(@"to %0.2f %0.2f %0.2f %0.2f", toComponents[0], toComponents[1], toComponents[2], toComponents[3]);
...
//                TTDWARNING(@"from [%0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f]", fromTransform.m11, fromTransform.m12, fromTransform.m13, fromTransform.m14, fromTransform.m21, fromTransform.m22, fromTransform.m23, fromTransform.m24, fromTransform.m31, fromTransform.m32, fromTransform.m33, fromTransform.m34, fromTransform.m41, fromTransform.m42, fromTransform.m43, fromTransform.m44);

//                TTDWARNING(@"to [%0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f; %0.2f %0.2f %0.2f %0.2f]", toTransform.m11, toTransform.m12, toTransform.m13, toTransform.m14, toTransform.m21, toTransform.m22, toTransform.m23, toTransform.m24, toTransform.m31, toTransform.m32, toTransform.m33, toTransform.m34, toTransform.m41, toTransform.m42, toTransform.m43, toTransform.m44);
...
- (NSArray *)createTransformArrayFromM11:(NSArray *)m11 M12:(NSArray *)m12
                                     M13:(NSArray *)m13 M14:(NSArray *)m14
                                     M21:(NSArray *)m21 M22:(NSArray *)m22
                                     M23:(NSArray *)m23 M24:(NSArray *)m24
                                     M31:(NSArray *)m31 M32:(NSArray *)m32
                                     M33:(NSArray *)m33 M34:(NSArray *)m34
                                     M41:(NSArray *)m41 M42:(NSArray *)m42
                                     M43:(NSArray *)m43 M44:(NSArray *)m44 {
...
- (NSArray *)valueArrayForStartValue:(CGFloat)startValue endValue:(CGFloat)endValue {
    ...
    if (self.stiffness == SJBounceAnimationStiffnessHeavy) {
        stiffnessCoefficient = 0.001f;
    } else if (self.stiffness == SJBounceAnimationStiffnessLight) {
